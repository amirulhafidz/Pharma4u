                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($order->status == 'Pending')
                                                <a href="{{route(
                                                    'client.pending_to_confirm',$order->id )}}" class="btn btn-block btn-success" id="confirmOrder">Confirm Order
                                                    </a>
                                            @elseif ($order->status == 'confirm')
                                                <a href="{{route('client.confirm_to_process',$order->id)}}" class="btn btn-block btn-success"
                                                id="processingOrder">Processing Order
                                                </a>
                                            @elseif ($order->status == 'processing')
                                                    <a href="{{route('client.process_to_delivered',
                                                    $order->id
