            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" action="{{route('update.unit') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea type="text"  name="description" id="example-text-input" class="form-control" rows="5">
                                        {{$unit->description}}
                                    </textarea>
                                    </div>
                                </div>
