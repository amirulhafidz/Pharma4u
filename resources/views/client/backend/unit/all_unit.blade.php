        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">All Unit</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('add.unit') }}" class="btn btn-primary waves-effect waves-light">Add Unit</a>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
           ...
           @foreach ($unit as $key => $item)  
            ...
            $discount = ($amount / $item->price) * 100;
                                                ...
                                                <td><a href="{{ route('edit.unit', $item->id) }}"
                                                 class="btn btn-info waves-effect waves-light"><i class="fas fa-edit"></i></a>
                                                <a href="{{ route('delete.unit', $item->id) }}" 
                                                class="btn btn-danger waves-effect waves-light" id="delete"><i class=" fas fa-trash"></i></a>
