                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        ...
                                        <span class="logo-txt">Pharma4u</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    ...
                                    @endif
                                    <form class="mt-4 pt-2" action="{{ route('client.password_submit') }}" method="post">
                                        @csrf
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        <script>document.write(new Date().getFullYear())</script> r.syurga
                                        <i class="mdi mdi-heart text-danger"></i> by DEZE ANG ANG ANG GOK
                                    </p>
                                </div>
                            </div>
                        </div>
