...
('upload/client_images/' . $profileData->photo) : url('upload/no_image.jpg')}}" alt=""
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <label for="example-text-input" class="form-label">Pharmacy Info</label>
                                    ...
                                    <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url
('upload/client_images/' . $profileData->cover_photo) : url('upload/no_image.jpg')}}" alt=""
                                        class="p-1 bg-primary" width="210" height="100">
