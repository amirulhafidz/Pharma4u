                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index.html" class="d-block auth-logo">
                                        ...
                                        <span class="logo-txt">Pharmacy Register</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Join Us!</h5>
                                        <p class="text-muted mt-2">Register an account to Pharma4u.</p>
                                    </div>
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0">Already have have an account ? <a href="{{ route('client.login') }}"
                                                class="text-primary fw-semibold"> Login here </a> </p>
                                    </div>
                                </div>
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">©
                                        <script>document.write(new Date().getFullYear())</script> Pharma
