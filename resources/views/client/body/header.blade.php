        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt="" height="24"> <span class="logo-txt">Pharmacy</span>
                    </span>
                </a>
...
('upload/client_images/' . $profileData->photo) : url('upload/no_image.jpg')}}"
                        alt="Header Avatar">
