...
<div class="page-content">
    ...
    @if ($status === '1')
    <h4>Pharmacy Account is <span class="text-success">Active</span> </h4>

    @else
    <h4>Pharmacy Account is <span class="text-danger">Inactive</span> </h4>
    <p class="text-danger"><b>Please wait for admin to approve your account</b></p>
