                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('admin.add.unit') }}" class="btn btn-primary waves-effect waves-light">Add
                                Unit</a>
                        </ol>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($unit as $key => $item)  
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.edit.unit', $item->id) }}"
                                                class="btn btn-info waves-effect waves-light"><i
                                                    class="fas fa-edit"></i></a>

                                            <a href="{{ route('admin.delete.unit', $item->id) }}"
