                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="group_name" class="form-select">
                                                ...
                                                >Category</option>
                                                <option value="City"{{$permission->group_name == 'City' ? 'selected' : ''}}
                                                >City</option>
                                                <option value="Product"{{$permission->group_name == 'Product' ? 'selected' : ''}}
                                                >Product</option>
                                                <option value="Unit"{{$permission->group_name == 'Unit' ? 'selected' : ''}}
                                                >Unit</option>
                                                <option value="Pharmacy"{{$permission->group_name == 'Pharmacy' ? 'selected' : ''}}
                                                >Pharmacy</option>
                                                <option value="Order"{{$permission->group_name == 'Order' ? 'selected' : ''}}
                                                >Order</option>
                                                <option value="Reports"{{$permission->group_name == 'Reports' ? 'selected' : ''}}
                                                >Reports</option>
